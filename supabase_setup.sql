...
-- ── Stock table (add this if you already ran the original SQL) ──
...
-- Seed stock for the 6 default chemicals
insert into stock (chemical_name, unit, current_stock, capacity, low_stock_threshold) values
  ('Amistar (Fungicide)',    'L',  8,   20,  4),
  ('Roundup (Herbicide)',    'L',  15,  25,  5),
  ('Karate (Insecticide)',   'L',  3,   10,  2),
  ('Serenade (Bio Control)', 'L',  6,   20,  4),
  ('Solufeed (Feed)',        'kg', 12,  50,  10),
  ('Moddus (Growth Reg)',    'L',  1.5, 5,   1);
